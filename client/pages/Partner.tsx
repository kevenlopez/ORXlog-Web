...
export default function Partner() {
  ...
  const validateWebsite = (website: string) => {
    ...
    return (
      domainParts.length >= 2 && domainParts[domainParts.length - 1].length >= 2
    );
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      alert(
        "¡Gracias! Nos pondremos en contacto contigo pronto para discutir la alianza.",
      );
      navigate("/");
    }
  };
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="flex-1 lg:pt-6">
            ...
            <p className="text-orx-primary text-lg leading-relaxed">
              ORXlog está revolucionando la industria con tecnología que reduce
              costos de SIEM hasta 70% mientras mejora la detección de amenazas.
            </p>
          </div>
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`w-4 h-4 text-gray-400 transition-transform ${showCountryListDropdown ? "rotate-180" : ""}`}
                      />
                    </button>
                  ...
                  <div className="flex max-w-[245px]">
                    <div className="relative">
                      ...
                      >
                        ...
                        <ChevronDown
                          className={`w-3 h-3 text-gray-400 transition-transform ${showCountryCodeDropdown ? "rotate-180" : ""}`}
                        />
                      </button>
