      ...
      <div className="flex-shrink-0 w-full lg:w-[472px]">
        <div className="grid grid-cols-2 gap-3 lg:gap-5">
          <div className="bg-orx-bg2 rounded-3xl p-4">
            <div className="text-3xl lg:text-5xl font-normal text-orx-primary mb-2">
              {t("benefits.stats.1")}
            </div>
            <p className="text-orx-primary text-sm leading-tight">
              {t("benefits.stats.1.desc")}
            </p>
          </div>
      ...
      <div className="flex-shrink-0 w-full lg:w-[472px] flex flex-col items-center gap-6">
        <div className="bg-gray-800 rounded-3xl p-8 w-full">
          ...
          <div className="space-y-4 text-sm font-mono">
            ...
            <div className="text-blue-400">
              ✓ Filtered 89% noise (1.07M events)
            </div>
            <div className="text-purple-400">✓ Enriched with threat intel</div>
            <div className="text-green-400">
              ✓ Pipeline active - 94% cost reduction achieved
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <div className="h-8 bg-gray-200 rounded px-4 flex items-center text-xs">
              CrowdStrike
            </div>
            <div className="h-8 bg-gray-200 rounded px-4 flex items-center text-xs">
              Fortinet
        ...
        <div className="bg-orx-bg2 rounded-3xl p-6 h-[600px] flex flex-col justify-between">
          ...
          <div className="border border-purple-300 rounded-2xl p-4 bg-purple-50">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="bg-purple-100 rounded-lg p-2 text-center text-xs">
                Servers
              </div>
              <div className="bg-purple-100 rounded-lg p-2 text-center text-xs">
                Security
          ...
          <div className="border border-blue-300 rounded-2xl p-4 bg-blue-50">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="bg-blue-100 rounded-lg p-2 text-center text-xs">
                Cloud
              </div>
              <div className="bg-blue-100 rounded-lg p-2 text-center text-xs">
                SIEM
      ...
      <div className="flex-shrink-0 w-full lg:w-[472px] flex flex-col items-center gap-6">
        <div className="bg-orx-bg2 rounded-3xl p-8 w-full">
          <div className="flex gap-4 mb-6">
            <svg
              className="w-12 h-12 text-orx-blue flex-shrink-0"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <div>
              <p className="text-orx-primary text-xl mb-4">
        ...
        <div className="bg-white rounded-[40px] p-8">
            ...
            <div className="hidden lg:flex justify-center gap-6 flex-wrap">
              ...
              >
                <svg className="w-4 h-4" viewBox="0 0 17 16" fill="none">
                  <path
                    d="M13.8334 9.6665V4.33317C13.8334 3.07584 13.8334 2.44784 13.4427 2.05717C13.0521 1.6665 12.4241 1.6665 11.1667 1.6665H5.83341C4.57608 1.6665 3.94808 1.6665 3.55741 2.05717C3.16675 2.44784 3.16675 3.07584 3.16675 4.33317V9.6665"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M5.83337 5.59606H5.94137C6.48203 5.59606 6.7527 5.59606 6.95937 5.71206C7.16603 5.82806 7.25803 6.03206 7.44403 6.44073L7.66803 6.93406C7.79003 7.20339 7.85137 7.33739 7.95003 7.33339C8.0487 7.32939 8.09137 7.19073 8.17737 6.91339L8.9487 4.43139C9.03737 4.14606 9.08203 4.00339 9.18137 4.00006C9.2807 3.99673 9.3407 4.13539 9.45937 4.41339L9.5947 4.72873C9.7747 5.14739 9.86403 5.35673 10.0727 5.47606C10.2814 5.59539 10.5567 5.59606 11.1074 5.59606H11.1667M2.83203 10.3434L3.18003 9.66673H13.8014L14.168 10.3434C15.13 12.1181 15.37 13.0054 15.004 13.6694C14.638 14.3334 13.6694 14.3334 11.7307 14.3334H5.26937C3.33003 14.3334 2.3607 14.3334 1.99537 13.6694C1.62937 13.0054 1.86937 12.1181 2.83203 10.3434Z"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              >
                <svg className="w-4 h-4" viewBox="0 0 17 16" fill="none">
                  <path
                    d="M7.78394 13.0469L7.8728 13.332L7.11206 12.3955L7.51245 12.1807L7.78394 13.0469ZM9.88647 12.3955L9.12573 13.332L9.21558 13.0469L9.48608 12.1807L9.88647 12.3955Z"
                    stroke="currentColor"
                    strokeWidth="1.5"
                  />
                </svg>
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            ...
            <div className="flex gap-4">
              ...
              >
                <ChevronLeft
                  className={`w-4 h-4 ${currentIndex === 0 ? "text-gray-400" : "text-white"}`}
                />
              </button>
              <button
                onClick={goToNextTab}
              ...
              >
                <ChevronRight
                  className={`w-4 h-4 ${currentIndex === tabs.length - 1 ? "text-gray-400" : "text-orx-blue"}`}
                />
              </button>
            </div>
