...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.dataVolume)
      newErrors.dataVolume = "El volumen de datos es requerido";
    if (!formData.dataSources)
      newErrors.dataSources = "El número de fuentes es requerido";
    if (!formData.acceptTerms)
      newErrors.acceptTerms = "Debe aceptar los términos";
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="flex-1 lg:pt-6">
            ...
            <h1 className="text-3xl lg:text-4xl font-bold text-orx-primary mb-4 leading-tight">
              Cada día que tu SIEM opera ineficientemente es dinero perdido y
              riesgo incrementado
            </h1>

            <p className="text-orx-primary text-lg leading-relaxed">
              Agenda una demostración personalizada y comprueba cómo ORXlog
              puede reducir tus costos de SIEM hasta un 70% mientras mejora la
          ...
          <div
            ref={formRef}
            className="w-full lg:w-[580px] bg-white rounded-3xl p-8 border border-gray-200 shadow-xl"
          >
            <h2 className="text-2xl font-medium text-orx-primary mb-6">
              Agenda una demo
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`w-4 h-4 text-gray-400 transition-transform ${showVolumeDropdown ? "rotate-180" : ""}`}
                      />
                    </button>
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`w-4 h-4 text-gray-400 transition-transform ${showSourcesDropdown ? "rotate-180" : ""}`}
                      />
                    </button>
              ...
              <div className="flex items-start gap-3">
                ...
                <label
                  htmlFor="terms"
                  className="text-orx-primary text-sm leading-relaxed"
                >
