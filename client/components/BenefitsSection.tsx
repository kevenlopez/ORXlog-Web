      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-[40px] p-8">
          ...
          <div className="mb-10">
            ...
            {/* Mobile tabs - Icons only with text below */}
            <div className="lg:hidden grid grid-cols-4 gap-2 max-w-sm mx-auto">
              ...
              >
                ...
                <span className="text-xs text-center leading-tight">{t('benefits.tabs.benefits')}</span>
              </button>
              ...
              >
                ...
                <span className="text-xs text-center leading-tight">{t('benefits.tabs.how')}</span>
              </button>
              ...
              >
                ...
                <span className="text-xs text-center leading-tight">{t('benefits.tabs.architecture')}</span>
              </button>
              ...
              >
                ...
                <span className="text-xs text-center leading-tight">{t('benefits.tabs.usecases')}</span>
              </button>
            </div>
          </div>
