        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-3xl border border-gray-200 p-6">
            <div className="text-left">
              <p className="text-orx-primary text-sm mb-8">
                {t("dataflow.step1")}
              </p>
              <div className="relative">
                <span className="text-4xl lg:text-6xl font-normal text-orx-primary">
                  26.12
                </span>
                <span className="text-xl lg:text-2xl text-orx-blue absolute bottom-2 ml-2">
                  GB
                </span>
              </div>
            </div>
