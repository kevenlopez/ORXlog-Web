...
const resources = {
  es: {
    translation: {
      ...
      "hero.subtitle":
        "ORXlog transforma el caos de los datos en inteligencia accionable para equipos de ciberseguridad. Optimiza, correlaciona y entrega visibilidad profunda desde un solo punto.",
      ...
      "benefits.accelerate.desc":
        " con correlación de eventos y alertas contextuales basadas en Mitre Att&ck.",
      ...
      "benefits.stats.3": "+90%",
      "benefits.stats.3.desc":
        "De detecciones con enriquecimiento automatizado.",
      "benefits.stats.4": "12 min",
      "benefits.stats.4.desc":
        "De media para un análisis completo post incidente",
      ...
      "how.receive.desc":
        " desde múltiples fuentes (firewalls, endpoints, nubes, apps).",
      ...
      "how.visualize.desc":
        " desde dashboards personalizados o integra con tu SIEM.",
      "how.terminal.title": "ORXlog Terminal v2.1",
      "how.compatible": "Compatible con +60 tecnologías:",

      // Architecture tab
      "arch.title.1":
        "Una plataforma modular, escalable y agnóstica, diseñada para integrarse con ",
      "arch.title.2": "cualquier entorno.",
      "arch.description":
        "ORXlog opera como una capa de inteligencia entre tus fuentes de datos y las plataformas de análisis o respuesta. Se despliega de forma ",
      ...
      "arch.processing.desc":
        " Motor de reducción, enriquecimiento y correlación de eventos.",
      "arch.delivery": "Entrega y visualización:",
      "arch.delivery.desc":
        " Dashboards, APIs, Alertas, y forwarding flexible a SIEMs, Data Lakes o herramientas SOAR.",
      ...
      "usecases.soc.desc":
        "Aumenta la capacidad de detección sin saturar tu SIEM.",
      "usecases.devsec": "DevSecOps / Cloud Security",
      "usecases.devsec.desc":
        "Flujo optimizado de datos para pipelines de seguridad.",
      "usecases.testimonial":
        "Con ORXlog logramos visibilidad real de nuestros entornos sin disparar los costos de nuestro SIEM",
      "usecases.testimonial.author":
        "Directora de Seguridad, Sector financiero",
      ...
      // Footer
      "footer.description":
        "La inteligencia de logs que impulsa la seguridad del futuro.",
  ...
  en: {
    translation: {
      ...
      "hero.subtitle":
        "ORXlog transforms data chaos into actionable intelligence for cybersecurity teams. Optimize, correlate and deliver deep visibility from a single point.",
      ...
      "benefits.accelerate.desc":
        " with event correlation and contextual alerts based on Mitre Att&ck.",
      ...
      "how.receive.desc":
        " from multiple sources (firewalls, endpoints, clouds, apps).",
      ...
      "how.visualize.desc":
        " from custom dashboards or integrate with your SIEM.",
      "how.terminal.title": "ORXlog Terminal v2.1",
      "how.compatible": "Compatible with +60 technologies:",

      // Architecture tab
      "arch.title.1":
        "A modular, scalable and agnostic platform, designed to integrate with ",
      "arch.title.2": "any environment.",
      "arch.description":
        "ORXlog operates as an intelligence layer between your data sources and analysis or response platforms. It deploys as ",
      ...
      "arch.processing.desc":
        " Reduction, enrichment and event correlation engine.",
      "arch.delivery": "Delivery and visualization:",
      "arch.delivery.desc":
        " Dashboards, APIs, Alerts, and flexible forwarding to SIEMs, Data Lakes or SOAR tools.",
      ...
      "usecases.soc.desc":
        "Increases detection capacity without saturating your SIEM.",
      "usecases.devsec": "DevSecOps / Cloud Security",
      "usecases.devsec.desc": "Optimized data flow for security pipelines.",
      "usecases.testimonial":
        "With ORXlog we achieved real visibility of our environments without skyrocketing our SIEM costs",
      ...
      // Footer
      "footer.description":
        "The log intelligence that powers the security of the future.",
